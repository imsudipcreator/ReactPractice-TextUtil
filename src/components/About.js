...
export default function About(props) {
  ...
  <div className={`accordion m-5 `} id="accordionExample">
    ...
    <div className={`accordion-item bg-${props.mode} text-${props.mode=='dark'?'light':'dark'}`} >
        ...
        <button className={`accordion-button collapsed bg-${props.mode} text-${props.mode=='dark'?'light':'dark'}`}  type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
            Accordion Item #1
        </button>
        </h2>
